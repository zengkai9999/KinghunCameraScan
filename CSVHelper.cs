...
namespace CameraScan
{
    class CSVHelper
    {
        ...
        public static int  WriteCSV(string filePathName,List<String[]>ls)
        {
          return WriteCSV(filePathName,true,ls);
        }

        public static int WriteCSV(string filePathName,bool append, List<string[]> ls)
        {
            try
            {
        ...
        public static int ReadCSV(string filePathName, List<string[]> ls)
        {
              try 
              {
